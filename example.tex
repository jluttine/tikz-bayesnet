...
\maketitle
TikZ examples for graphical models. The directed factor graph notation
is used in most figures, but it is possible to use the same macros to
draw Bayesian networks.
